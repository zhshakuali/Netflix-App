...
//  Netflix App
//
//  Created by Жансая Шакуали on 25.09.2023.
//
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        APICaller.shared.getMovie(with: titleName) { [weak self] result in
            ...
            case .success(let videoElement):
                self?.delegate?.searchResultsControllerDidTap(TitlePreviewViewModel(title: titleName, youtubeView: videoElement, titleOverview: title.overview ?? ""))
